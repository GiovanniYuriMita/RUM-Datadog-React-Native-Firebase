...
const sampleUsers = {
  'Carlos Silva': {
    email: 'carlao.guanabara@gmail.com',
    id: '1136',
  },
  'Rovilson Ribeiro': {
    email: 'rovilsonribeiro2001@gmail.com',
    id: '1137',
  },
  'Ana Paula': {
    email: 'a.paulasp@outlook.com.br',
    id: '1138',
  },
  'Alberto Teixeira' : {
    email: 'albertoteixeira245@gmail.com',
    id: '1139',
  }
};

const userKeys = Object.keys(sampleUsers);

const getRandomUser = () => {
  const randomKey = userKeys[Math.floor(Math.random() * userKeys.length)];
  return { key: randomKey, ...sampleUsers[randomKey as keyof typeof sampleUsers] };
};
    ...
    <DatadogProvider configuration={config} onInitialization={onSDKInitialized}>
      ...
      >
        <SafeAreaView style={styles.container}>
          ...
          <Button title="Encerrar sessão" onPress={endSession} />
